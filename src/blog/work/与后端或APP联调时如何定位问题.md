...
爱又米长沙前端 > 与后端或APP联调时如何定位问题 > image2018-10-31 13:58:11.png
...
其它思路：上述思路能解决多平台的问题，虽然底层代码是异步调用的，但打包出来依然有各平台的判断代码遗留，如果能在打包代码时，根据各环境来引入对应代码，无关的代码不打包进来就更好了。以后有机会实践看看能否成形吧。
...
SyntaxError: Unexpected keyword 'const'. Const declarations are not supported in strict mode.这就是低端机型不支持es6。
